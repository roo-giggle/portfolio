...
const  NavBar= () => {
  ...
  return (
    <div className='flex justify-between items-center w-full px-4 h-20 text-white bg-black fixed'>
       <div><h1 className='text-5xl font-signature ml-2'>Roopal</h1></div> 
        ...
        <li key={id}
        className='px-4 cursor-pointer capitalize font-medium text-pink-500 hover:text-white hover:scale-105 duration-200'>
